...
int speedstep(int n,int d,int s,int update)
{
	...
	speed = clamp(speed, 0, (SPEEDMAX-1));
...
int eng_char(int n)
{
	...
	switch (map[n].ch_status) 
	{
		...
		// unknown
		default: xlog(0,"Unknown ch_status %d",map[n].ch_status); return 0;
	}
...
int eng_item(int n)
{
	...
	switch (map[n].it_status) 
	{
		...
		case  2:    // four-sprite animation, 2-step
		case  3:
		case  4:
		case  5:
		...
		case  6:    // two-sprite animation, 1-step
		case  7:
			m = (map[n].it_status-6);
			if ((ctick-1)%2)
			{
		...
		case  8:    // eight-sprite animation, 1-step
		case  9:
		case 10:
		case 11:
		case 12:
		...
		case 16:    // five sprite animation, 1-step
		case 17:
		case 18:
		case 19:
		case 20:

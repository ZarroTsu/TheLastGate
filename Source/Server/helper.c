...
int use_soulstone_replace_item(int cn, int in, int temp, int v)
{
	int in2;
...
int use_soulstone_mod_reservation(int cn, int in)
{
	int in2, n, m;
...
int use_soulstone_special(int cn, int in)
{
	int in2;
	...
	{
		// Simple flowers
		case IT_FLO_R: if (use_soulstone_replace_item(cn, in, IT_POT_M_HP, 3)) return 1; break;
		case IT_FLO_G: if (use_soulstone_replace_item(cn, in, IT_POT_M_EN, 3)) return 1; break;
		case IT_FLO_P: if (use_soulstone_replace_item(cn, in, IT_POT_M_MP, 3)) return 1; break;
		
		// Impromptu Ring Creation
		case IT_S_SA: if (use_soulstone_replace_item(cn, in, IT_RI_SSSA, 1)) return 1; break;
		case IT_S_RU: if (use_soulstone_replace_item(cn, in, IT_RI_SSRU, 1)) return 1; break;
		case IT_S_AM: if (use_soulstone_replace_item(cn, in, IT_RI_SSAM, 1)) return 1; break;
		case IT_S_TO: if (use_soulstone_replace_item(cn, in, IT_RI_SSTO, 1)) return 1; break;
		case IT_S_EM: if (use_soulstone_replace_item(cn, in, IT_RI_SSEM, 1)) return 1; break;
		case IT_S_DI: if (use_soulstone_replace_item(cn, in, IT_RI_SSDI, 1)) return 1; break;
		
		// Gemstone downgrades
		case IT_M_SA: if (use_soulstone_replace_item(cn, in, IT_S_SA, 1)) return 1; break;
		case IT_M_RU: if (use_soulstone_replace_item(cn, in, IT_S_RU, 1)) return 1; break;
		case IT_M_AM: if (use_soulstone_replace_item(cn, in, IT_S_AM, 1)) return 1; break;
		case IT_M_TO: if (use_soulstone_replace_item(cn, in, IT_S_TO, 1)) return 1; break;
		case IT_M_EM: if (use_soulstone_replace_item(cn, in, IT_S_EM, 1)) return 1; break;
		case IT_M_DI: if (use_soulstone_replace_item(cn, in, IT_S_DI, 1)) return 1; break;
		case IT_B_SA: if (use_soulstone_replace_item(cn, in, IT_M_SA, 1)) return 1; break;
		case IT_B_RU: if (use_soulstone_replace_item(cn, in, IT_M_RU, 1)) return 1; break;
		case IT_B_AM: if (use_soulstone_replace_item(cn, in, IT_M_AM, 1)) return 1; break;
		case IT_B_TO: if (use_soulstone_replace_item(cn, in, IT_M_TO, 1)) return 1; break;
		case IT_B_EM: if (use_soulstone_replace_item(cn, in, IT_M_EM, 1)) return 1; break;
		case IT_B_DI: if (use_soulstone_replace_item(cn, in, IT_M_DI, 1)) return 1; break;
		case IT_H_SA: if (use_soulstone_replace_item(cn, in, IT_B_SA, 1)) return 1; break;
		case IT_H_RU: if (use_soulstone_replace_item(cn, in, IT_B_RU, 1)) return 1; break;
		case IT_H_AM: if (use_soulstone_replace_item(cn, in, IT_B_AM, 1)) return 1; break;
		case IT_H_TO: if (use_soulstone_replace_item(cn, in, IT_B_TO, 1)) return 1; break;
		case IT_H_EM: if (use_soulstone_replace_item(cn, in, IT_B_EM, 1)) return 1; break;
		case IT_H_DI: if (use_soulstone_replace_item(cn, in, IT_B_DI, 1)) return 1; break;
		case IT_H_SP: if (use_soulstone_replace_item(cn, in, IT_B_SP, 1)) return 1; break;
		case IT_H_CI: if (use_soulstone_replace_item(cn, in, IT_B_CI, 1)) return 1; break;
		case IT_H_OP: if (use_soulstone_replace_item(cn, in, IT_B_OP, 1)) return 1; break;
		case IT_H_AQ: if (use_soulstone_replace_item(cn, in, IT_B_AQ, 1)) return 1; break;
		case IT_F_SA: if (use_soulstone_replace_item(cn, in, IT_H_SA, 1)) return 1; break;
		case IT_F_RU: if (use_soulstone_replace_item(cn, in, IT_H_RU, 1)) return 1; break;
		case IT_F_AM: if (use_soulstone_replace_item(cn, in, IT_H_AM, 1)) return 1; break;
		case IT_F_TO: if (use_soulstone_replace_item(cn, in, IT_H_TO, 1)) return 1; break;
		case IT_F_EM: if (use_soulstone_replace_item(cn, in, IT_H_EM, 1)) return 1; break;
		case IT_F_DI: if (use_soulstone_replace_item(cn, in, IT_H_DI, 1)) return 1; break;
		case IT_F_SP: if (use_soulstone_replace_item(cn, in, IT_H_SP, 1)) return 1; break;
		case IT_F_CI: if (use_soulstone_replace_item(cn, in, IT_H_CI, 1)) return 1; break;
		case IT_F_OP: if (use_soulstone_replace_item(cn, in, IT_H_OP, 1)) return 1; break;
		case IT_F_AQ: if (use_soulstone_replace_item(cn, in, IT_H_AQ, 1)) return 1; break;
		case IT_F_BE: if (use_soulstone_replace_item(cn, in, IT_H_BE, 1)) return 1; break;
		case IT_F_ZI: if (use_soulstone_replace_item(cn, in, IT_H_ZI, 1)) return 1; break;
		case IT_F_PH: if (use_soulstone_replace_item(cn, in, IT_H_PH, 1)) return 1; break;
		
		// Stone cycle
		case IT_SM_WHET: if (use_soulstone_replace_item(cn, in, IT_SM_CLAY, 1)) return 1; break;
		case IT_SM_CLAY: if (use_soulstone_replace_item(cn, in, IT_SM_MAGE, 1)) return 1; break;
		case IT_SM_MAGE: if (use_soulstone_replace_item(cn, in, IT_SM_GRAD, 1)) return 1; break;
		case IT_SM_GRAD: if (use_soulstone_replace_item(cn, in, IT_SM_WHET, 1)) return 1; break;
		
		// Potion cycle
		case IT_POT_M_HP: if (use_soulstone_replace_item(cn, in, IT_POT_M_EN, 1)) return 1; break;
		case IT_POT_M_EN: if (use_soulstone_replace_item(cn, in, IT_POT_M_MP, 1)) return 1; break;
		case IT_POT_M_MP: if (use_soulstone_replace_item(cn, in, IT_POT_M_HP, 1)) return 1; break;
		case IT_POT_N_HP: if (use_soulstone_replace_item(cn, in, IT_POT_N_EN, 1)) return 1; break;
		case IT_POT_N_EN: if (use_soulstone_replace_item(cn, in, IT_POT_N_MP, 1)) return 1; break;
		case IT_POT_N_MP: if (use_soulstone_replace_item(cn, in, IT_POT_N_HP, 1)) return 1; break;
		case IT_POT_G_HP: if (use_soulstone_replace_item(cn, in, IT_POT_G_EN, 1)) return 1; break;
		case IT_POT_G_EN: if (use_soulstone_replace_item(cn, in, IT_POT_G_MP, 1)) return 1; break;
		case IT_POT_G_MP: if (use_soulstone_replace_item(cn, in, IT_POT_G_HP, 1)) return 1; break;
		case IT_POT_H_HP: if (use_soulstone_replace_item(cn, in, IT_POT_H_EN, 1)) return 1; break;
		case IT_POT_H_EN: if (use_soulstone_replace_item(cn, in, IT_POT_H_MP, 1)) return 1; break;
		case IT_POT_H_MP: if (use_soulstone_replace_item(cn, in, IT_POT_H_HP, 1)) return 1; break;
		case IT_POT_S_HP: if (use_soulstone_replace_item(cn, in, IT_POT_S_EN, 1)) return 1; break;
		case IT_POT_S_EN: if (use_soulstone_replace_item(cn, in, IT_POT_S_MP, 1)) return 1; break;
		case IT_POT_S_MP: if (use_soulstone_replace_item(cn, in, IT_POT_S_HP, 1)) return 1; break;
		case IT_POT_C_HP: if (use_soulstone_replace_item(cn, in, IT_POT_C_EN, 1)) return 1; break;
		case IT_POT_C_EN: if (use_soulstone_replace_item(cn, in, IT_POT_C_MP, 1)) return 1; break;
		case IT_POT_C_MP: if (use_soulstone_replace_item(cn, in, IT_POT_C_HP, 1)) return 1; break;
		case IT_POT_L_HP: if (use_soulstone_replace_item(cn, in, IT_POT_L_EN, 1)) return 1; break;
		case IT_POT_L_EN: if (use_soulstone_replace_item(cn, in, IT_POT_L_MP, 1)) return 1; break;
		case IT_POT_L_MP: if (use_soulstone_replace_item(cn, in, IT_POT_L_HP, 1)) return 1; break;
		case IT_POT_D_HP: if (use_soulstone_replace_item(cn, in, IT_POT_D_EN, 1)) return 1; break;
		case IT_POT_D_EN: if (use_soulstone_replace_item(cn, in, IT_POT_D_MP, 1)) return 1; break;
		case IT_POT_D_MP: if (use_soulstone_replace_item(cn, in, IT_POT_D_HP, 1)) return 1; break;
		case IT_POT_VITA: if (use_soulstone_replace_item(cn, in, IT_POT_CLAR, 1)) return 1; break;
		case IT_POT_CLAR: if (use_soulstone_replace_item(cn, in, IT_POT_SAGE, 1)) return 1; break;
		case IT_POT_SAGE: if (use_soulstone_replace_item(cn, in, IT_POT_VITA, 1)) return 1; break;
		...
		case IT_RI_ROPS: case IT_RI_ROTD: case IT_TORCH:
			if (use_soulstone_mod_reservation(cn, in)) return 1;
			break;
		//
		default: break;
	}

...
#define HAS_ENCH(in, n)			(it[(in)].enchantment == (n))
...
#define IS_CASTCOMP(cn)			(IS_SANECHAR(cn) && (ch[(cn)].temp == CT_CASTERCOMP || ch[(cn)].temp == CT_ARCHCASTER))
...
#define IS_SPELL(a)				((a==7||a==11||a==15||a==17||a==18||a==19||a==20||a==21||a==24||a==25||a==26||a==27||a==42||a==43||a==46||a==47)?1:0)
#define IS_SPELLEX(a)			((a==5||a==6||a==7||a==8||a==11||a==12||a==15||a==17||a==18||a==19||a==20||a==21||a==23||a==24||a==25||a==26||a==27||a==29||a==32||a==42||a==43||a==46||a==47||a==50||a==51||a==52||a==59||a==64||a==65||a==67)?1:0)
...
#define IS_REPLYMINION(cn)		(ch[(cn)].temp == CT_COMPANION || ch[(cn)].temp == CT_ARCHCOMP || ch[(cn)].temp == CT_CASTERCOMP || ch[(cn)].temp == CT_ARCHCASTER || ch[(cn)].temp == CT_GARGTHRALL || ch[(cn)].temp == CT_DEVDTHRALL || ch[(cn)].temp == CT_INVITHRALL)
...
#define IS_SEYANSKILL(n)		(n==SK_WARCRY||n==SK_PULSE||n==SK_LEAP||n==SK_LETHARGY||n==SK_GCMASTERY||n==SK_ZEPHYR||n==SK_PRECISION||n==SK_PACT)
...
#define T_WARR_SK(cn, a)		((IS_WARRIOR(cn)     && T_SKT((cn), (a)))?1:0)
#define T_SORC_SK(cn, a)		((IS_SORCERER(cn)    && T_SKT((cn), (a)))?1:0)
#define T_SUMM_SK(cn, a)		((IS_SUMMONER(cn)    && T_SKT((cn), (a)))?1:0)

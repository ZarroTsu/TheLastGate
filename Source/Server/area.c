...
//   _x1_, _y1_, _x2_, _y2_, "Area Name",                      0 = in  /  1 = the  /  2 = on  /  3 = at
	...
	{ 527,  566,  534,  575, "Faiza's House",                  0},
	{ 523,  568,  526,  577, "Faiza's House",                  0},
...
//   _x1_, _y1_, _x2_, _y2_, "Area Name",                      0 = in  /  1 = the  /  2 = on  /  3 = at
	...
	{ 865,  124,  919,  143, "Underground I",                  1},
...
//   _x1_, _y1_, _x2_, _y2_, "Area Name",                      0 = in  /  1 = the  /  2 = on  /  3 = at
	...
	{ 522,  604,  530,  614, "Ludolf's House",                 0},
	{ 572,  591,  582,  599, "Flanders' House",                0},
	{ 590,  613,  600,  621, "Oswald's House",                 0},
	{ 636,  592,  644,  602, "Aster's House",                  0},
	...
	{ 433,  756,  540,  784, "Sadem Ridge",                    2},
	{ 578,  687,  637,  755, "Thug's Camp",                    1},
	{ 638,  687,  649,  718, "Thug's Camp",                    1},
	{ 726,  157,  770,  189, "Thug's Hideaway",                1},
...
//   _x1_, _y1_, _x2_, _y2_, "Area Name",                      0 = in  /  1 = the  /  2 = on  /  3 = at
	...
	{ 884,  377,  964,  465, "The Emerald Palace",             3},
	{ 956,  483,  964,  491, "The Emerald Palace",             3},
//   _x1_, _y1_, _x2_, _y2_, "Area Name",                      0 = in  /  1 = the  /  2 = on  /  3 = at
...
//   _x1_, _y1_, _x2_, _y2_, "Area Name",                      0 = in  /  1 = the  /  2 = on  /  3 = at
	...
	{ 811,  878,  842,  884, "Neiseer",                        0},
	{ 647,  770,  685,  798, "Park",                           1},
	{ 179, 1026,  263, 1110, "Dimling's Den",                  1},
...
//   _x1_, _y1_, _x2_, _y2_, "Area Name",                      0 = in  /  1 = the  /  2 = on  /  3 = at
	...
	{ 757,  777,  767,  788, "Brenna's House",                 0},
	{ 757,  792,  767,  803, "Rikus' House",                   0},
	{ 658,  807,  669,  816, "Dwyn's House",                   0},
...
//   _x1_, _y1_, _x2_, _y2_, "Area Name",                      0 = in  /  1 = the  /  2 = on  /  3 = at
	...
	{ 829,  951,  876,  968, "The Violet Bog",                 0},
	{ 834,  969,  876,  984, "The Violet Bog",                 0},
	{ 829,  985,  876, 1003, "The Violet Bog",                 0},
	{ 877,  885,  881,  982, "The Violet Bog",                 0},
	{ 882,  885,  898,  973, "The Violet Bog",                 0},
	{ 899,  885,  915,  946, "The Violet Bog",                 0},
	{ 916,  885,  924,  939, "The Violet Bog",                 0},
	{ 863,  997,  871, 1003, "Desolate Shrine",                1},
	{ 848,  904,  873,  930, "Thaumaturge's Hut",              1},
	{ 286, 1026,  312, 1052, "Thaumaturge's Basement",         1},
	{ 814,  943,  820,  950, "Fallen Catacomb",                1},
	{ 814,  951,  828, 1003, "Fallen Catacomb",                1},
	{ 829,  969,  833,  984, "Fallen Catacomb",                1},
	{ 800,  977,  813, 1003, "Fallen Catacomb",                1},
	{ 877,  983,  881, 1003, "Violet Thicket",                 1},
	{ 882,  974,  947, 1003, "Violet Thicket",                 1},
	{ 948,  983,  951, 1003, "Violet Thicket",                 1},
	{ 899,  947,  933,  973, "Violet Thicket",                 1},
	{ 916,  940,  924,  946, "Violet Thicket",                 1},
	{ 216, 1246,  306, 1336, "Temple in the Sky",              1},
//   _x1_, _y1_, _x2_, _y2_, "Area Name",                      0 = in  /  1 = the  /  2 = on  /  3 = at
	{ 553,  767,  643,  817, "The Ravaged Prairie",            2},
	{ 565,  818,  643,  826, "The Ravaged Prairie",            2},
	{ 553,  827,  643,  877, "The Ravaged Prairie",            2},
	{ 644,  844,  650,  877, "The Ravaged Prairie",            2},
	{ 623,  832,  635,  841, "Jasper's House",                 0},
...
//   _x1_, _y1_, _x2_, _y2_, "Area Name",                      0 = in  /  1 = the  /  2 = on  /  3 = at
	...
	{ 890,  841,  924,  847, "The Raging Rivers",              3},
	{ 895,  848,  924,  855, "The Raging Rivers",              3},
...
//   _x1_, _y1_, _x2_, _y2_, "Area Name",                      0 = in  /  1 = the  /  2 = on  /  3 = at
	...
	{ 132,  153,  152,  167, "Lab XIII, Gatekeeper's Gorge",   0},
	{ 132,  168,  152,  181, "Lab XIII, Gatekeeper's Prep",    0},
	{ 136,  182,  148,  192, "Lab XIII, Gatekeeper's Test",    0},
	{ 136,  193,  148,  246, "Lab XIII, Gatekeeper's Reward",  0},
	...
	{  93, 1473,  172, 1565, "Lab XVIII, Commandment Gorge",   0},
	{  93, 1586,  261, 1754, "Lab XIX, Divinity Gorge",        0},
	{ 193, 1473,  215, 1487, "Lab XX, Final Gorge",            0},
	{ 193, 1488,  215, 1502, "Lab XX, Final Preparations",     0},
	{ 193, 1503,  215, 1534, "Lab XX, Final Approach",         0},
	{ 193, 1543,  215, 1565, "Lab XX, Final Test",             0},
	{ 884,  504,  964,  534, "Hall of Lost Souls",             1},
	{ 884,  478,  938,  492, "Hall of Foul Smells",            1},
...
//    _x_, _y_, "123456789012345678901234567890", 	"..."
	...
	{ 838, 893, "Neiseer, East", 					"the entrance to the Violet Bog, east of Neiseer" },				//  16777216

...
void randomize_soulstone_stats(int cn, int in, int rank, int sk);
int make_new_soulstone(int cn, int rank, int sk);
void give_new_soulstone(int cn, int rank);
int make_new_catalyst(int cn, int n, int v);
int make_new_focus(int cn);
void create_new_soulstone_equipment(int cn, int in, int rank, int sk);

...
struct sk_tree sk_tree[10][12]={
	{	// Seyan'du
		...
		{ "Avoidance",                     "+4 to Parry Score.",
		  6624,                            "" },
		//"         '         '         ", "         '         '         '         '         "
		{ "Absolution",                    "2%% more damage dealt for each buff or debuff on you.",
		  6604,                            "" },
		{ "Rigor",                         "4%% increased total Hit Score.",
		  6689,                            "" },
		{ "Scorn",                         "Your skills and spells ignore 20%% of enemy immunity.",
		  6606,                            "" },
		//"         '         '         ", "         '         '         '         '         "
		{ "Determination",                 "Gain +1 to Weapon and Armor Value for every 25 total attributes.",
		  6615,                            "" },
		{ "Jack of All Trades",            "5%% increased total Attributes.",
		  6608,                            "" },
		{ "Brilliance",                    "Gain +1 to Spellpower Bonus for every 25 total attributes.",
		  6623,                            "" },
		//"         '         '         ", "         '         '         '         '         "
		...
		{ "Flexibility",                   "4%% increased total Parry Score.",
		  6695,                            "" },
		{ "Penance",                       "2%% less damage taken for each buff or debuff on you.",
		  6612,                            "" }
	}, // "         '         '         ", "         '         '         '         '         "
	{	// Arch Templar
		...
		{ "Toughness",                     "+4 to Armor Value.",
		  6603,                            "" },
		//"         '         '         ", "         '         '         '         '         "
		{ "Bulwark",                       "30%% less Top Damage taken from enemies attacking you.",
		  6612,                            "" },
		{ "Vanquisher",                    "10%% increased total Top Damage.",
		  6701,                            "" },
		{ "Impact",                        "Your minimum hit damage is equal to your maximum hit damage.",
		  6702,                            "" },
		//"         '         '         ", "         '         '         '         '         "
		{ "Barbarism",                     "Your active melee skills gain an additional 20%% Strength bonus.",
		  6625,                            "" },
		{ "Overwhelming Strength",         "6%% increased total Strength. +10 to Strength Limit.",
		  6620,                            "" },
		{ "Overlord",                      "1%% increased effect of Warcry for every 10 total Strength.",
		  6619,                            "" },
		//"         '         '         ", "         '         '         '         '         "
		...
		{ "Unbreakable",                   "10%% increased total Armor Value.",
		  6611,                            "" },
		{ "Temperance",                    "1%% increased effect of Safeguard for every 10 total Armor Value.",
		  6622,                            "" }
	}, // "         '         '         ", "         '         '         '         '         "
	{	// Skald
		...
		{ "Sanctity",                      "+4 to Immunity.",
		  6667,                            "" },
		//"         '         '         ", "         '         '         '         '         "
		{ "Litheness",                     "50%% reduced extra damage taken from enemy critical strikes.",
		  6634,                            "" },
		...
		{ "Crushing Blows",                "Your Cleave skill can inflict critical hits.",
		  6616,                            "" },
		//"         '         '         ", "         '         '         '         '         "
		{ "Nocturne",                      "1%% increased effect of Precision for every 10 total Agility.",
		  6687,                            "" },
		{ "Overwhelming Agility",          "6%% increased total Agility. +10 to Agility Limit.",
		  6632,                            "" },
		{ "Celerity",                      "Your active melee skills gain an additional 20%% Agility bonus.",
		  6625,                            "" },
		//"         '         '         ", "         '         '         '         '         "
		{ "Guardian",                      "Your Aria grants affected allies 20%% of your total Immunity.",
		  6672,                            "" },
		{ "Indifference",                  "10%% increased total Immunity.",
		  6681,                            "" },
		{ "Bastion",                       "20%% reduced reservation of hitpoints, endurance, or mana.",
		  6628,                            "" }
	}, // "         '         '         ", "         '         '         '         '         "
	{	// Warrior
		{ "Rapidity",                      "",
	...
	{	// Lycanthrope
		...
		{ "Envy",                          "20%% increased total Thorns score.",
		  6617,                            "" },
		{ "Serration",                     "Bleeding inflicted by you deals 1%% increased damage per 2 points of Thorns score.",
		  6702,                            "" }
	}, // "         '         '         ", "         '         '         '         '         "
	{	// Contract
...
struct sk_tree sk_corrupt[NUM_CORR]={
   // "         '         '         ", "         '         '         '         '         "
	...
	{ "False Avoidance",               "(+2) to Parry Score.",
	  6624,                            "" },
	//"         '         '         ", "         '         '         '         '         "
	{ "False Absolution",              "(+1%%) more damage dealt for each buff or debuff on you.",
	  6604,                            "" },
	{ "False Rigor",                   "(+2%%) increased total Hit Score.",
	  6689,                            "" },
	{ "False Scorn",                   "Your skills and spells ignore (+10%%) of enemy immunity.",
	  6606,                            "" },
	//"         '         '         ", "         '         '         '         '         "
	{ "False Determination",           "Gain (+1) to Weapon and Armor Value for every 50 total attributes.",
	  6615,                            "" },
	{ "Master of None",                "(+5) to all Skill and Attribute limits.",
	  6704,                            "" },
	{ "False Brilliance",              "Gain (+1) to Spellpower Bonus for every 50 total attributes.",
	  6623,                            "" },
	//"         '         '         ", "         '         '         '         '         "
	...
	{ "False Flexibility",             "(+2%%) increased total Parry Score.",
	  6695,                            "" },
	{ "False Penance",                 "(+1%%) less damage taken for each buff or debuff on you.",
	  6612,                            "" },
	//"         '         '         ", "         '         '         '         '         " ////////
	...
	{ "False Toughness",               "(+2) to Armor Value.",
	  6603,                            "" },
	//"         '         '         ", "         '         '         '         '         "
	{ "False Bulwark",                 "(+15%%) less Top Damage taken from enemies attacking you.",
	  6612,                            "" },
	{ "False Vanquisher",              "(+5%%) increased total Top Damage.",
	  6701,                            "" },
	{ "Goliath",                       "(+15%%) increased effect of stats granted by Greataxes.",
	  6630,                            "" },
	//"         '         '         ", "         '         '         '         '         "
	{ "False Barbarism",               "Your active melee skills gain an additional (+10%%) Strength bonus.",
	  6625,                            "" },
	{ "False Strength",                "(+3%%) increased total Strength. (+5) to Strength Limit.",
	  6620,                            "" },
	{ "False Overlord",                "(+1%%) increased effect of Warcry for every 20 total Strength.",
	  6619,                            "" },
	//"         '         '         ", "         '         '         '         '         "
	{ "Full Cover",                    "(+15%%) incresed effect of stats granted by Shields.",
	  6690,                            "" },
	{ "False Unbreakable",             "(+5%%) increased total Armor Value.",
	  6611,                            "" },
	{ "False Temperance",              "(+1%%) increased effect of Safeguard for every 20 total Armor Value.",
	  6622,                            "" },
	//"         '         '         ", "         '         '         '         '         " ////////
	{ "* Force *",                     "",
	  6601,                            "" },
...
struct metaStat metaStats[103] = {
	...
	{ 35, 0, 1, "Rally Effect",         "Hit/Par", "Effective bonus to hit and parry score granted to allies when using your Rally skill." },

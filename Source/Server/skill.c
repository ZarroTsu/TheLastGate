...
struct metaStat metaStats[102] = {
	...
	//
	{ -1, 1, 1, "Cooldown Duration",    "x",       "Cooldown Duration is the multiplier that cooldown from skills is applied with, the lower the better. Affected by Cooldown Rate." },
	{ -1, 0, 4, "Spell Aptitude",       "",        "Spell Aptitude is how powerful a spell you can receive from any source. Determined by Willpower, Intuition, and base class Spell Modifier." },
	{ -1, 1, 4, "Spell Modifier",       "x",       "Spell Modifier is a multiplier which effects the strength of spells you cast. Determined by your character class." },
	{ -1, 1, 6, "Base Action Speed",    "",        "Base Action speed is the base speed at which ALL actions are performed. Determined by Agility and Strength." },
	{ -1, 1, 6, "Movement Speed",       "",        "Movement Speed is the speed at which your character runs around Astonia." },
	{ -1, 0, 7, "Hit Score",            "",        "Your Hit Score is the value used to determine the rate of hitting enemies in melee combat. Granted by your weapon skill and other sources." },
	{ -1, 0, 7, "Parry Score",          "",        "Your Parry Score is the value used to determine the rate of avoiding damage from enemies. Granted by your weapon skill and other sources." },
	//
	//   Offense Stats
	//
	{ -1, 0, 9, "  Passive Stats:",     "",        "" }, //  7
	{ -1, 1, 1, "Damage Multiplier",    "%",       "Damage Multiplier is the final multiplier for all damage you deal." },
	{ -1, 1, 7, "Est. Melee DPS",       "",        "Melee DPS is the average of your damage per hit, times your attack speed. Does not account for bonus damage from your Hit Score." },
	{ -1, 0, 5, "Est. Melee Hit Dmg",   "",        "Melee Hit Dmg ranges from 1/4 of your Weapon Value, to 1/4 of (your Weapon Value, plus half Strength, plus 14) times your Crit Chance & Crit Multi." },
	{ -1, 0, 5, "Critical Multiplier",  "%",       "Critical Multiplier is the damage multiplier upon dealing a successful critical hit." },
	{ -1, 1, 5, "Critical Chance",      "%",       "Critical Chance is the chance, out of 100.00, that you will inflict a melee critical hit. Determined by your equipped weapon, and increased by Braveness and other sources of Crit Chance." },
	{ -1, 0, 5, "Melee Ceiling Damage", "",        "Melee Ceiling Damage is the highest possible damage a melee hit may deal. This is affected by increases to Top Damage and your critical hit scores." },
	...
	{ -1, 1, 6, "Attack Speed",         "",        "Attack speed is the speed at which melee attacks are performed. This is increased by Agility and other sources of Attack Speed." },
	{ -1, 1, 6, "  Cast Speed",         "",        "Cast Speed is the speed at which casting and action animations occur per second. This is increased by Willpower and other sources of Cast Speed." },
	{ -1, 0, 1, "Thorns Score",         "",        "Thorns is damage dealt to attackers when you are successfully hit (even if you take no damage). Does not damage attackers if they fail to hit you." },
	{ -1, 1, 4, "Mana Cost Multiplier", "%",       "Mana Cost Multiplier is the multiplier of mana for spells, determined by your Concentrate skill." },
	{ -1, 0, 1, "Total AoE Bonus",      "Tiles",   "Total AoE Bonus is a flat increase to area-of-effect skills." },
	{ -2, 0, 0, "", "", "" }, // blank
	{ -2, 0, 0, "", "", "" }, // blank
	{ -2, 0, 0, "", "", "" }, // blank
	{ -1, 0, 9, "  Active Stats:",      "",        "" }, // 23
	{ 40, 1, 5, "Cleave Hit Damage",    "",        "Damage dealt by your Cleave skill, before reduction from target Parry Score and Armor Value. Surrounding targets take 3/4 of this value." },
	{ 40, 1, 5, "Cleave Bleed Degen",   "/s",      "Effective damage over time dealt by Bleeding caused by Cleave, before reduction from target Parry Score, Armor Value and Immunity." },
	...
	{ 49, 0, 1, "Leap # of Repeats",    "Repeats", "Damage dealt by your Leap skill, before reduction from target Parry Score and Armor Value. Surrounding targets take 3/4 of this value." },
	...
	{ 24, 1, 4, "Blast Hit Damage",     "",        "Damage dealt by your Blast spell, before reduction from target Immunity and Armor Value. Surrounding targets take 3/4 of this value." },
	...
	{ 43, 0, 1, "Pulse Hit Damage",     "/tick",   "Damage dealt by the Pulse spell to surrounding enemies when pulsing, before reduction from target Immunity and Armor Value." },
	{ 43, 0, 1, "Pulse Count",          "",        "Number of pulses expected during the duration of your Pulse spell, determined by the rate of pulses from Cooldown Rate." },
	{ 43, 1, 1, "Pulse Cooldown",       "Seconds", "Skill exhaustion duration expected upon using your Pulse spell." },
	{  7, 1, 6, "Zephyr Hit Damage",    "",        "Damage granted by your Zephyr spell, before reduction from target Parry Score and Armor Value. This occurs one second after a successful hit." },
	{ 44, 1, 4, "Immolate Degen",       "/s",      "Effective damage over time dealt to nearby enemies while affected by Immolate, before reduction from enemy Immunity." },
	{ -2, 0, 0, "", "", "" }, // blank
	{ 27, 0, 1, "Ghost Comp Potency",   "",        "Effective power of your Ghost Companion, granted by your Ghost Companion spell. A higher number grants a stronger companion." },
	{ 27, 1, 1, "Ghost Comp Cooldown",  "Seconds", "Skill exhaustion duration expected upon using your Ghost Companion spell." },
	{ 46, 0, 4, "Shadow Copy Potency",  "",        "Effective power of your Shadow Copy, granted by your Shadow Copy spell. A higher number grants a stronger companion." },
	...
	{ -1, 0, 7, "Effective Hitpoints",  "",        "Your effective total hitpoints, taken by dividing your maximum hitpoints by your damage reduction multiplier, as well as any effects which nullify damage or transfer it to endurance or mana." },
	{ -1, 1, 5, "Health Regen Rate",    "/s",      "Rate at which health is regenerated per second. This is improved by the Regenerate skill, and can be further adjusted by various items." },
	{ -1, 1, 6, "Endurance Regen Rate", "/s",      "Rate at which endurance is regenerated per second. This is improved by the Rest skill, and can be further adjusted by various items." },
	{ -1, 1, 4, "Mana Regen Rate",      "/s",      "Rate at which mana is regenerated per second. This is improved by the Meditate skill, and can be further adjusted by various items." },
	{ -1, 0, 1, "Effective Immunity",   "",        "Estimated Immunity score. This displays your 'true' Immunity value after adjustments that do not display on the skill list." },
	{ -1, 0, 1, "Effective Resistance", "",        "Estimated Resistance score. This displays your 'true' Resistance value after adjustments that do not display on the skill list." },
	{ -1, 1, 6, "Attack Speed",         "",        "Attack speed is the speed at which melee attacks are performed. This is increased by Agility and other sources of Attack Speed." },
	{ -1, 1, 6, "  Cast Speed",         "",        "Cast Speed is the speed at which casting and action animations occur per second. This is increased by Willpower and other sources of Cast Speed." },
	{ -1, 0, 1, "Thorns Score",         "",        "Thorns is damage dealt to attackers when you are successfully hit (even if you take no damage). Does not damage attackers if they fail to hit you." },
	{ -1, 1, 4, "Mana Cost Multiplier", "%",       "Mana Cost Multiplier is the multiplier of mana for spells, determined by your Concentrate skill." },
	{ -1, 0, 4, "Total AoE Bonus",      "Tiles",   "Total AoE Bonus is a flat increase to area-of-effect skills." },
	{ -1, 0, 4, "Buffing Apt Bonus",    "",        "Aptitude Bonus granted to target allies when casting friendly spells. This is granted by Willpower." },
	{ -1, 1, 1, "Underwater Degen",     "/s",      "Rate at which health is lost while underwater. This can be reduced by the Metabolism skill, and can be further reduced by other items." },
	{ -2, 0, 0, "", "", "" }, // blank
	...
	{ 37, 0, 5, "Blind Effect",         "",        "Effective reduction of target Hit and Parry Scores when using your Blind skill, before reduction from target Immunity." },
	{ 37, 1, 5, "Blind Cooldown",       "Seconds", "Skill exhaustion duration expected upon using your Blind skill." },
	{ 35, 0, 1, "Warcry Effect",        "Attribs", "Effective reduction of target attributes when using your Warcry skill, before reduction from target Immunity." },
	{ 35, 1, 1, "Warcry Cooldown",      "Seconds", "Skill exhaustion duration expected upon using your Warcry skill." },
	{ 41, 0, 5, "Weaken Effect",        "WV",      "Effective reduction of target Weapon Value when using your Weaken skill, before reduction from target Immunity." },
	{ 41, 1, 5, "Weaken Cooldown",      "Seconds", "Skill exhaustion duration expected upon using your Weaken skill." },
	{ 20, 0, 2, "Curse Effect",         "Attribs", "Effective reduction of target attributes when casting your Curse spell, before reduction from target Immunity." },
	{ 20, 1, 2, "Curse Cooldown",       "Seconds", "Skill exhaustion duration expected upon using your Curse spell." },
	{ 19, 0, 4, "Slow Effect",          "Speed",   "Effective reduction of target action speed when casting your Slow spell, before reduction from target Immunity." },
	...
	{ 42, 1, 4, "Venom Degen",          "/s",      "Effective damage over time dealt by each individual stack of your Venom spell, before reduction from target Immunity. This can be stacked up to three times." },
	...
	{ 11, 0, 4, "M.Shell Effect",       "Res&Imm", "Effective increase to Resistance and Immunity Scores granted by your Magic Shell spell. Decreases as you take or avoid debuffs." },
	...
	{ 37, 1, 5, "Douse Effect",         "%",       "Effective reduction of target Spell Modifier when using your Douse skill, before reduction from target Immunity." },
	{ 37, 1, 5, "Douse Cooldown",       "Seconds", "Skill exhaustion duration expected upon using your Douse skill." },
	{ 35, 0, 1, "Rally Effect",         "Hit/Par", "Effective bonus to hit and parry score granted to allies when using your Rally skill. Half of this value is granted to yourself as well." },
	{ 35, 1, 1, "Rally Cooldown",       "Seconds", "Skill exhaustion duration expected upon using your Rally skill." },
	{ 41, 0, 5, "Crush Effect",         "AV",      "Effective reduction of target Armor Value when using your Crush skill, before reduction from target Immunity." },

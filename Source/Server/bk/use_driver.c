...
int use_map_chest(int cn, int in)
{
	...
	if (rank <= 8) 			// Sergeants
	{
		switch (RANDOM(12+tier))
		{
			...
			default:	n = RANDOM(2)?IT_RPOT:IT_POT_RAIN;			break;
		}
	}
	else if (rank <= 14) 	// Officers
	{
		switch (RANDOM(12+tier))
		{
			...
			case  6:	
			case  7: 	n = IT_POP_ASPEL+RANDOM(7); 				break;
			case  8:	n = RANDOM(2)?IT_RPOT:IT_POT_RAIN; 			break;
			case  9:	n = -1000;									break;
			case 10:	n = !RANDOM(3)?(RANDOM(2)?131:273):127; 	break;
			case 11: 	n = IT_CH_FOOL; 							break;
			default:	n = RANDOM(2)?IT_RD_HP+RANDOM(2)*2:IT_POT_VITA+RANDOM(3); break;
		}
	}
	else if (rank <= 19) 	// Generals
	{
		switch (RANDOM(12+tier))
		{
			...
			case  8:	n = RANDOM(2)?IT_RD_HP+RANDOM(2)*2:IT_POT_VITA+RANDOM(3); break;
			case  9:	n = -1000;									break;
			case 10:	n = RANDOM(6)?2510:(IT_BL_SOLAR+RANDOM(2));	break;
			case 11: 	n = IT_CH_FOOL_R; 							break;
			default:	n = RANDOM(2)?IT_GPOT:IT_RPOT;				break;
		}
	}
	else if (rank <= 24)	// Nobles
	{
		switch (RANDOM(12+tier))
		{
			...
			case  6:	
			case  7: 	n = IT_POP_ISPEL+RANDOM(7); 				break;
			case  8:	n = RANDOM(2)?IT_GPOT:IT_RPOT; 				break;
			case  9:	n = -1000;									break;
			case 10:	n = RANDOM(6)?2511:(1243+RANDOM(2)*2);		break;
			case 11: 	n = IT_CH_FOOL_R; 							break;
			default:	n = RANDOM(2)?IT_RD_BRV+RANDOM(5):IT_RD_HP+RANDOM(2)*2; break; 
		}
	}
	else					// Uber
	{
		switch (RANDOM(12+tier))
		{
			...
			case  8:	n = RANDOM(2)?IT_SPOT:IT_GPOT; 				break;
			case  9:	n = -1000;									break;
			case 10:	n = RANDOM(2)?IT_RD_BRV+RANDOM(5):IT_RD_HP+RANDOM(2)*2; break;
